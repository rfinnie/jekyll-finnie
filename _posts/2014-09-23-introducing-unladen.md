...
This made me think of my idea from 2002, and the result is (or will be) [Unladen](https://forge.colobox.com/rfinnie/unladen). Unladen is a Swift client-compatible system which takes a much different approach to the backend.
